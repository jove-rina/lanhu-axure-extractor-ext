export const LANG = {
  zh_CN: {
    ...
    titlePlaceholder: '请输入模块标题，或点击「拾取」从页面提取',
    contentPlaceholder: '请输入条目 $1 的内容（支持 Markdown），或点击 🎯 从页面拾取',
  ...
  en: {
    ...
    titlePlaceholder: 'Enter module title, or click Pick to extract from the page',
    contentPlaceholder: 'Enter content for entry $1 (Markdown supported), or click 🎯 to pick from page',
